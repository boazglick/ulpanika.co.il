module.exports = {
  siteUrl: "https://ulpanika.co.il", // Site domain. Do not include a trailing slash!

  postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

  siteTitleMeta: "ulpanika", // This allows an alternative site title for meta data for pages.
  siteDescriptionMeta:
    "ulpanika", // This allows an alternative site description for meta data for pages.

  shareImageWidth: 1000, // Change to the width of your default share image
  shareImageHeight: 523, // Change to the height of your default share image

  shortTitle: "ulpanika", // Used for App manifest e.g. Mobile Home Screen
  ...
  header: {
    navigation: [
      {
        label: "דף הבית",
        url: "https://ulpanika.co.il/",
      },
      {
        label: "יצירת קשר",
        url: "https://ulpanika.co.il/contact",
      },
    ],
  },
  footer: {
    ...
    navigation: [
      ...
      {
        label: "Sitemap",
        url: "https://ulpanika.co.il/sitemap.xml",
      },
